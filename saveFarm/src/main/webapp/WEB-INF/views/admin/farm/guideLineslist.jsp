                     ...
                     <div class="row m-0">
                      ...
                      <ul class="nav nav-tabs" id="myTab" role="tablist">
							<li class="nav-item" role="presentation">
								<button class="nav-link ${classify==100?'active':''}" id="tab-1" data-toggle="tab" data-bs-target="#tab-pane" type="button" role="tab" aria-controls="1" aria-selected="${classify==2?'true':'false'}">전체</button>
							</li>
							<li class="nav-item" role="presentation">
								<button class="nav-link ${classify==200?'active':''}" id="tab-2" data-toggle="tab" data-bs-target="#tab-pane" type="button" role="tab" aria-controls="2" aria-selected="${classify==3?'true':'false'}">가입서류 가이드라인</button>
							</li>
							<li class="nav-item" role="presentation">
								<button class="nav-link ${classify==300?'active':''}" id="tab-3" data-toggle="tab" data-bs-target="#tab-pane" type="button" role="tab" aria-controls="3" aria-selected="${classify==4?'true':'false'}">유통 가이드라인</button>
							</li>
							<li class="nav-item" role="presentation">
								<button class="nav-link ${classify==400?'active':''}" id="tab-4" data-toggle="tab" data-bs-target="#tab-pane" type="button" role="tab" aria-controls="4" aria-selected="${classify==5?'true':'false'}">상품등록 가이드라인</button>
							</li>
						</ul>
                      ...
                      <table class="table datatables" id="dataTable-1">
                        ...
                        <tbody>
                          <tr>
                            <td>1</td>
                            <td>
                            	<a href="" class="text-secondary">세이브팜 유통 가이드라인</a>
                            </td>
                            <td>관리자</td>
                            <td>2025-08-10</td>
                            <td>
                            	<a href="" class="text-reset"><i class="fe fe-download" style="font-size:18px;"></i></a>
                            </td>
                          </tr>
                        </tbody>
                      </table>
