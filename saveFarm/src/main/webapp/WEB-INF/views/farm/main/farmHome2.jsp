	...
	<section class="hero__v6 section" id="home">
	  <div class="container">
	    <div class="row">
	      ...
	      <div class="col-lg-6">
	        <div class="hero-img"><img class="img-card img-fluid" src="dist/farmMain/images/mainTitle2.png" alt="Image card" data-aos="fade-down" data-aos-delay="600"><img class="img-main img-fluid rounded-4" src="dist/farmMain/images/mainTitle1.jpg" alt="Hero Image" data-aos="fade-in" data-aos-delay="500"></div>
	      </div>
	    </div>
	  </div>
	  <!-- End Hero-->
	    ...
	    <div class="row">
	      <div class="col-md-6 order-md-2">
	        <div class="row justify-content-end">
	          <div class="col-md-11 mb-4 mb-md-0"><span class="subtitle text-uppercase mb-3" data-aos="fade-up" data-aos-delay="0">농산물, 제대로 팔겠습니다</span>
	            <h2 class="mb-4" data-aos="fade-up" data-aos-delay="100">못난이 농산물, 제대로 팔겠습니다<br>농민과 소비자 사이, 우리가 직접 책임집니다</h2>
	    ...
	    <div class="row">
	      ...
	      <div class="col-md-4 mb-4 mb-md-0" data-aos="fade-up" data-aos-delay="300">
	        <div class="p-5 rounded-4 price-table h-100">
	          <h3><i class="bi bi-box-seam me-2"></i> 농가회원 참여 방식</h3>
	          ...
	          <div class="mt-4"><a class="btn" href="#">입점 신청하기</a></div>
	        </div>
	      </div>
	        ...
	        <div class="p-5 rounded-4 price-table popular h-100">
	          <div class="row">
	            ...
	            <div class="col-md-6 pricing-features d-none d-md-block">
	              <img src="dist/farmMain/images/mainTitle3.png" alt="긴급 구조 상품예시" class="img-fluid rounded-4 shadow-sm">
	            </div>
	          </div>
	        </div>
	      </div>
	      ...
	      <div class="col-md-6 col-lg-2">
	        <div class="step-card text-center h-100 d-flex flex-column justify-content-start position-relative" data-aos="fade-up" data-aos-delay="0">
	          <div data-aos="fade-right" data-aos-delay="500">
	            <img class="arch-line" src="dist/farmMain/images/svg/arch-line.svg" alt="Flow Line">
	          </div>
	      ...
	      <div class="col-md-6 col-lg-2" data-aos="fade-up" data-aos-delay="600">
	        <div class="step-card reverse text-center h-100 d-flex flex-column justify-content-start position-relative">
	          <div data-aos="fade-right" data-aos-delay="1100">
	            <img class="arch-line reverse" src="dist/farmMain/images/svg/arch-line-reverse.svg" alt="Flow Line">
	          </div>
	      ...
	      <div class="col-md-6">
	        <div class="form-wrapper" data-aos="fade-up" data-aos-delay="300">
	          <form id="contactForm">
	            ...
	            <div class="row gap-3 mb-3">
	              <div class="col-md-12">
	                <label class="mb-2" for="subject">재배중인 농산물 분류</label>
	            ...
	            <div class="row gap-3 gap-md-0 mb-3">
	              <div class="col-md-12">
	                <label class="mb-2" for="message">기타 코멘트</label>
	          ...
	          <div class="mt-3 d-none alert alert-success" id="successMessage">소식지 신청이 완료되었습니다!</div>
	          <div class="mt-3 d-none alert alert-danger" id="errorMessage">소식지 신청이 실패되었습니다. 다시 작성바랍니다.</div>
	        </div>
	      </div>
	    </div>
	  </div>
