...
<!-- Template JS Files -->
<script type="text/javascript" src="${pageContext.request.contextPath}/dist/js/wow.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/dist/js/owl.carousel.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/dist/js/main.js"></script>